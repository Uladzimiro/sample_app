...
describe "User Pages" do
  ...
  describe "Profile page" do
    ...
    let!(:mm1) { FactoryGirl.create(:micropost, user: wrong_user, content: "Tweet1") }
    let!(:mm2) { FactoryGirl.create(:micropost, user: wrong_user, content: "Tweet2") }
    ...
    describe "contains delete links" do
